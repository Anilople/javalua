...
class ByteUtilsTest {
  ...
  void encodeShortBigEndian() {
    assertArrayEquals(
        ...
        ByteUtils.encodeShortBigEndian((short) 0x1234)
    );
  }
  ...
  void encodeShortLittleEndian() {
    assertArrayEquals(
        ...
        ByteUtils.encodeShort((short) 0x1234, false)
    );
  }

  @Test
  void decodeLongLowPartBigEndian() {
    long value = ByteUtils.decodeLongBigEndian(new byte[]{
        0x00,
        0x00,
        0x00,
        0x00,
  ...
  void decodeLongLittleEndianLowestByte() {
    long value = ByteUtils.decodeLong(new byte[]{
        0x01,
        0x00,
        0x00,
        0x00,
