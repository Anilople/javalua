...
public final class BitwiseOperator extends AbstractOperator<LuaValue, LuaValue, LuaInteger> {
  ...
  public static final BitwiseOperator LUA_OPSHL = new BitwiseOperator(10, "<<", Bitwise::shiftLeft, SHL);
  public static final BitwiseOperator LUA_OPSHR =
      new BitwiseOperator(11, ">>", Bitwise::shiftRight, SHR);
  public static final BitwiseOperator LUA_OPBNOT = new BitwiseOperator(13, "~", Bitwise::negate, NOT);

  private BitwiseOperator(
      int enumCount, String content, BiFunction<LuaValue, LuaValue, LuaInteger> function, LuaString metaMethodName) {
